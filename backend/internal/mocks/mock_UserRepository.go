...
func (_m *MockUserRepository) Create(ctx context.Context, user *domain.User) (uuid.UUID, error) {
...
func (_c *MockUserRepository_Create_Call) RunAndReturn(run func(context.Context, *domain.User) (uuid.UUID, error)) *MockUserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
