...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Royal17x",
            "url": "https://github.com/Royal17x/flagr"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.createFlagRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateFlagRequest"
                        }
                    },
                    {
                        "type": "string",
